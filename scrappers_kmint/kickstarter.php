...
// for($i = 1; $i < 3 ; $i++){
    ...
    $codesource = file_get_contents("https://www.kickstarter.com/discover/advanced?woe_id=23424819&sort=newest&page=1");

    //  scraping titre
    preg_match_all("#(.+)#", $codesource, $tab_title, PREG_SET_ORDER);
    //<h3 class=\"type-18 light hover-item-text-underline mb1\">(.+)</h3>
